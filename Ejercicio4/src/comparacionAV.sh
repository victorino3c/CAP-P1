...
for ((i=1; i<=$repetitions; i+=1)); do
    ...
    SDV=$(./greyScaleModifiedAV SD.jpg | grep 'Tiempo:' | awk '{print $2}')
    HDV=$(./greyScaleModifiedAV HD.jpg | grep 'Tiempo:' | awk '{print $2}')
    FHDV=$(./greyScaleModifiedAV FHD.jpg | grep 'Tiempo:' | awk '{print $2}')
    ckV=$(./greyScaleModifiedAV 4k.jpg | grep 'Tiempo:' | awk '{print $2}')
    okV=$(./greyScaleModifiedAV 8k.jpg | grep 'Tiempo:' | awk '{print $2}')
