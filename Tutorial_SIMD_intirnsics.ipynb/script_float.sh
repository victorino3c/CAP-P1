...
do
    gcc dot_product_float.c -g -fopt-info -DREPS=10 -DARRAYSIZE=$i -lm -march=native -fwhole-program -Wall -D_GNU_SOURCE -o dot_producto
    gcc dot_product_float.c -O1 -g -fopt-info -DREPS=10 -DARRAYSIZE=$i -lm -march=native -fwhole-program -Wall -D_GNU_SOURCE -o dot_productoO1
    gcc dot_product_float.c -O2 -g -fopt-info -DREPS=10 -DARRAYSIZE=$i -lm -march=native -fwhole-program -Wall -D_GNU_SOURCE -o dot_productoO2
    gcc dot_product_float.c -O3 -g -fopt-info -DREPS=10 -DARRAYSIZE=$i -lm -march=native -fwhole-program -Wall -D_GNU_SOURCE -o dot_productoO3
